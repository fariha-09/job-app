        ...
        <div className="w-[90%] max-w-6xl flex flex-col items-center text-center">
          ...
          <div className="bg-white w-full max-w-2xl p-6 rounded-lg shadow-md border border-gray-200 flex flex-col mb-5">
            ...
            <div className="relative flex space-x-3 mb-5">
              ...
              <p className="text-gray-600 font-bold mb-0">Company Information</p>
            </div>
            ...
            <div className="flex flex-col items-start relative mb-4">
              <label className="mb-2 text-gray-700 font-medium">Company Email <span className="text-red-500 font-semibold">*</span></label>
              <HiOutlineMail className="absolute left-3 top-11 text-gray-700" />
              <input type="text" placeholder="company@example.com" className="p-2 pl-9 mb-2 border border-gray-200 rounded-lg w-full focus:outline-none focus:ring-2 focus:ring-blue-500" />
            </div>

            {/* Industry & Size */}
            <div className="flex flex-col lg:flex-row gap-4 mb-4 w-full">
              <div className="flex flex-col items-start w-full">
                <label className="mb-2 text-gray-700 font-medium">Industry <span className="text-red-500 font-semibold">*</span></label>
            ...
            <div className="flex flex-col items-start mb-4">
              <label className="mb-2 text-gray-700 font-medium">Website (Optional)</label>
              <input type="text" placeholder="https://yourcompany.com" className="p-2 pl-4 mb-2 border border-gray-200 rounded-lg w-full focus:outline-none focus:ring-2 focus:ring-blue-500" />
            </div>
            ...
            <label className="mb-2 text-gray-700 font-semibold flex flex-start pt-2">Additional Information (Optional)</label>
            ...
            <div className="flex flex-col items-start relative mb-4 w-full">
              ...
              <label htmlFor="resume-upload" className="cursor-pointer p-4 mb-2 w-full border-2 border-dotted border-gray-700 rounded-lg text-gray-500 text-sm text-center hover:bg-gray-50 transition">
            ...
            <div className="flex flex-col items-start mb-4 w-full">
              <label className="mb-2 text-gray-700 font-medium">Company Description</label>
              <textarea rows="4" placeholder="Brief description of your company and what you do..." className="p-2 text-gray-700 mb-2 border border-gray-200 rounded-lg w-full focus:outline-none focus:ring-2 focus:ring-blue-500"></textarea>
            </div>
            ...
            <div className="mt-4 space-y-4 text-sm text-gray-700 bg-blue-300/25 border border-gray-300 rounded-lg p-4">
              <div className="flex items-start gap-2">
                ...
                <label htmlFor="terms">I agree to the <a href="/terms" className="text-blue-600 font-semibold underline">Terms of Service</a> and <a href="/privacy" className="text-blue-600 font-semibold underline">Privacy Policy</a> <span className="text-red-500 font-semibold">*</span></label>
              </div>

              <div className="flex items-start gap-2">
                <input type="checkbox" id="alerts" className="mt-1 accent-blue-600" />
                <label htmlFor="alerts">Send me hiring tips and platform updates via email</label>
              </div>
            </div>
