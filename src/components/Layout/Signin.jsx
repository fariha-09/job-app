  ...
  const handleLogin = async (e) => {
    ...
    try {
      const res = await fetch(
        "https://job-portal-production-1bac.up.railway.app/api/login",
        {
          method: "POST",
          credentials: "include",
    ...
    <>
      ...
      <section className="bg-blue-300/10 min-h-screen flex items-center justify-center px-4">
        <form
          ...
          autoComplete="off"
          className="bg-white w-full max-w-md md:w-1/2 p-6 rounded-lg shadow-md border border-gray-200"
        >
          ...
          <div className="flex items-center justify-between mb-5">
            ...
            <Link to="" className="text-[#7F4DFF] font-semibold text-sm">
              Forgot password?
            </Link>
          </div>
          ...
          <button
            type="submit"
            className="bg-[#7F4DFF] w-full text-white py-2 rounded-xl mb-5"
          >
            Sign In
          </button>
          ...
          <div className="flex justify-center">
            ...
            <Link
              to="/signuppage"
              className="text-[#7F4DFF] font-semibold ml-2"
            >
              Sign up
            </Link>
          </div>
