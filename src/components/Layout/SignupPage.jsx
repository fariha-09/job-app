...
export default function LoginPage() {
  ...
  return (
    <>
      <Header />
      {step === 1 ? (
        <section className="bg-blue-300/10 pb-20 flex justify-center ">
          <form className="bg-white  w-[50%]  p-6 mt-15 rounded-lg shadow-md border border-gray-200">
            ...
            <div className="flex gap-4 mb-4 ml-10">
              <div className="flex flex-col items-start relative">
                ...
                <input
                  ...
                  className="p-2 pl-9 mb-2 border border-gray-200 w-60 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500"
                />
              </div>
              <div className="flex flex-col items-start ml-10">
                ...
                <input
                  ...
                  onChange={handleChange}
                  placeholder="Doe"
                  className="p-2  mb-2 border border-gray-200 w-60 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500"
                />
              </div>
            </div>
            ...
            <div className="flex gap-4 mb-4 ml-10">
              <div className="flex flex-col items-start relative">
                ...
                <input
                  ...
                  onChange={handleChange}
                  placeholder=""
                  className="p-2 pl-9 border border-gray-200 w-60 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500"
                />
                  <button
                type="button"
            ...
            <button
              onClick={handleContinue}
              className="bg-[#7F4DFF] w-135 ml-10 text-white text-center  py-2 rounded-xl mb-5 block"
            >
              Continue
            </button>
        ...
        <section className="bg-blue-300/10 pb-20 flex justify-center">
          <form
            ...
            className="bg-white  w-[50%]  p-6 mt-15 rounded-lg shadow-md border border-gray-200"
          >
            <h2 className="text-xl font-semibold mb-1">Create Your Account</h2>
            <p className="text-gray-600 mb-6">
            ...
            <div className="flex items-center justify-center mb-8">
              <p className="flex items-center justify-center w-8 h-8 bg-gray-300 text-gray-600 rounded-full">
                1
              </p>
              <div className="w-16 border-t border-blue-500"></div>
              <p className="flex items-center justify-center w-8 h-8  bg-blue-500 text-white  rounded-full">
                2
              </p>
            </div>
            <div className="flex gap-4 mb-4 ml-10">
              ...
              <div className="flex flex-col items-start">
                ...
                <select
                  className="p-2 w-60  border mb-2 bg-white/30 border-gray-300 text-gray-700 font-medium rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500"
                  value={experience}
                  name="experience"
...
"
            ...
            <div className="bg-blue-300/3 border border-gray-300 h-50 w-135 rounded-lg p-2 ml-10 mt-5">
              <label className="mb-2 text-gray-700 font-semibold flex flex-start pt-2 pl-5">
            ...
            <div className="mt-4 space-y-4 text-sm text-gray-700 bg-blue-300/25 border border-gray-300 h-30 w-135 rounded-lg p-2 ml-10 pt-6 px-8 ">
            ...
            <div className="flex justify-start gap-4 mt-6 p-2 pl-10">
              <button
                onClick={clickChange}
