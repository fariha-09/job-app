...
export default function JobDetails() {
  ...
  useEffect(() => {
    const fetchJob = async () => {
      fetch( `https://job-portal-production.up.railway.app/jobs/${_id}`)
      .then(res=> res.json())
      .then(data => {
  ...
  return (
    <>
      ...
      <section className="bg-blue-300/10 pb-20">
        ...
        <div className="bg-white mx-auto w-[80%] p-6 mt-15 rounded-lg shadow-md border border-gray-200">
        ...
        <h1 className="text-lg font-bold  my-4">Similar Jobs You Might Like</h1>
        <div className="flex gap-6 w-[80%] justify-center mx-auto">
          {/* card 1 */}
          <div className="bg-white rounded-lg shadow-md p-6 w-1/2 border border-gray-200">
            <div className="flex items-start md:items-center gap-4 relative">
              <img
                src="https://upload.wikimedia.org/wikipedia/commons/4/4a/Logo_2013_Google.png"
                alt="logo"
